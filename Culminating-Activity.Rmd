...
```{r, echo=FALSE}
library(ggplot2)
setwd("~/Desktop/Coding/RStudio/Culminating-Activity/kNN-Classification-Culminating-Activity")
...
hist(dev_data$coffee_intake_mg,
     main = "Coffee Intake (mg)",
     xlab = "Coffee Intake (mg)",
     col = "skyblue",
     border = "white",
     breaks = 10)

hist(dev_data$distractions,
     main = "Distractions",
     xlab = "Distractions",
     col = "skyblue",
     border = "white",
...
task_freq <- table(dev_data$task_success)

barplot(task_freq,
        main = "Frequency of Task Success",
        xlab = "Task Success",
        ylab = "Frequency",
        col = "steelblue")
```
...
Conclusion
This study demonstrated that a k-Nearest Neighbors (kNN) classification model can effectively predict developer task success using productivity-related variables. The final kNN model showed balanced classification results across success and failure cases, with strong precision, recall, specificity, and F1-score. With an accuracy of 91%, the model exceeded the 90% threshold established in the hypothesis and showed that behavioral, workload-related, and AI-usage factors can be combined to produce reliable predictions of productivity outcomes.
